...
#       here check validity of some parameters
    ...
    def do_check_events(self, line):
        ...
        self.configure()
        evt_file = pjoin(self.me_dir,'Events',self.MWparam['mw_run']['inputfile'])         #CHANGED 1/04/15 --> Use the inputfile given in the MadWeight_Card!
    ...
    def do_launch(self, line):
        ...
        cards = ['param_card.dat', 'run_card.dat', 'madweight_card.dat', 
                 'transfer_card.dat', 'input.lhco'] #self.MWparam['mw_run']['inputfile'] ]
        if not self.force:
