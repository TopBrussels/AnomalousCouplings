...
"""
        ...
        if self.MWparam['mw_perm']['preselect'] == 'default' or self.MWparam['mw_perm']['preselect'] == 'nobperm':
            ...
            print 'Opening file for preselection : ',pjoin(self.directory,'../..',self.MWparam['mw_perm']['preselect'])
            fsock.write(open(pjoin(self.directory,'../..',self.MWparam['mw_perm']['preselect'])).read())   #Doesn't point to anything useful ...
...
#        text+=' parameter (max_branch='+str(len(self.ext_content))+')\n'        
    ...
    def write_permutations_file(self):
        ...
        permutations = get_perms_from_id(pid_list, self.MWparam['mw_perm']['bjet_is_jet'], self.MWparam['mw_perm']['bjet_perm'])
	print 'Value of self added bjet_perm variable = ',self.MWparam['mw_perm']['bjet_perm']
