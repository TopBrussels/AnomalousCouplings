...
GC_22 = Coupling(name = 'GC_22',
                 value = '(ElecC*complex(0,1)*gL)/(MW*sw*cmath.sqrt(2))',
                 order = {'NP':1,'TEST':1})

GC_23 = Coupling(name = 'GC_23',
                 value = '(ElecC*complex(0,1)*gR)/(MW*sw*cmath.sqrt(2))',
                 order = {'NP':1,'TEST':1})
...
GC_31 = Coupling(name = 'GC_31',
                 value = '-((ElecC*complex(0,1)*VL)/(sw*cmath.sqrt(2)))',
                 order = {'NP':1,'TEST':1})

GC_32 = Coupling(name = 'GC_32',
                 value = '-((ElecC*complex(0,1)*VR)/(sw*cmath.sqrt(2)))',
                 order = {'NP':1,'TEST':1})
...
GC_42 = Coupling(name = 'GC_42',
                 value = '-((ElecC*complex(0,1)*complexconjugate(gL))/(MW*sw*cmath.sqrt(2)))',
                 order = {'NP':1,'TEST':1})

GC_43 = Coupling(name = 'GC_43',
                 value = '-((ElecC*complex(0,1)*complexconjugate(gR))/(MW*sw*cmath.sqrt(2)))',
                 order = {'NP':1,'TEST':1})

GC_44 = Coupling(name = 'GC_44',
                 value = '(ElecC*complex(0,1)*complexconjugate(VL))/(sw*cmath.sqrt(2))',
                 order = {'NP':1,'TEST':1})

GC_45 = Coupling(name = 'GC_45',
                 value = '(ElecC*complex(0,1)*complexconjugate(VR))/(sw*cmath.sqrt(2))',
                 order = {'NP':1,'TEST':1})
