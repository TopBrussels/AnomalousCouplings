...
C+-----------------------------------------------------------------------+
        ...
        c_point(perm,4,1,2)=width_THETA_jet(pexp_init(0,2+perm_id(2)),tag_lhco(4))
        c_point(perm,4,2,2)=width_PHI_jet(pexp_init(0,2+perm_id(2)),tag_lhco(4))
        c_point(perm,4,3,2)=width_E_jet(pexp_init(0,2+perm_id(2)),tag_lhco(4))
        ...
        c_point(perm,5,1,2)=width_THETA_jet(pexp_init(0,2+perm_id(3)),tag_lhco(5))
        c_point(perm,5,2,2)=width_PHI_jet(pexp_init(0,2+perm_id(3)),tag_lhco(5))
        c_point(perm,5,3,2)=width_E_jet(pexp_init(0,2+perm_id(3)),tag_lhco(5))
        ...
        c_point(perm,7,1,2)=width_THETA_lepton(pexp_init(0,2+perm_id(5)),tag_lhco(7))
        c_point(perm,7,2,2)=width_PHI_lepton(pexp_init(0,2+perm_id(5)),tag_lhco(7))
        c_point(perm,7,3,2)=width_E_lepton(pexp_init(0,2+perm_id(5)),tag_lhco(7))

        c_point(perm,8,1,2)=-1d0
        c_point(perm,8,2,2)=-1d0
        c_point(perm,8,3,2)=-1d0

        c_point(perm, 9,1,1)=theta(pexp_init(0,2+perm_id(7)))
        c_point(perm, 9,2,1)=phi(pexp_init(0,2+perm_id(7)))
        c_point(perm, 9,3,1)=rho(pexp_init(0,2+perm_id(7)))
        c_point(perm,9,1,2)=width_THETA_jet(pexp_init(0,2+perm_id(7)),tag_lhco(9))
        c_point(perm,9,2,2)=width_PHI_jet(pexp_init(0,2+perm_id(7)),tag_lhco(9))
        c_point(perm,9,3,2)=width_E_jet(pexp_init(0,2+perm_id(7)),tag_lhco(9))
...
c                
      ...
      integer n_lhco
        ...
        n_lhco=tag_lhco(4)
        call tf_E_jet(pexp(0,4),p(0,4),n_lhco,weight)
        call tf_THETA_jet(pexp(0,4),p(0,4),n_lhco,weight)
        call tf_PHI_jet(pexp(0,4),p(0,4),n_lhco,weight)

        n_lhco=tag_lhco(5)
        call tf_E_jet(pexp(0,5),p(0,5),n_lhco,weight)
        call tf_THETA_jet(pexp(0,5),p(0,5),n_lhco,weight)
        call tf_PHI_jet(pexp(0,5),p(0,5),n_lhco,weight)
        ...
        n_lhco=tag_lhco(7)
        call tf_E_lepton(pexp(0,7),p(0,7),n_lhco,weight)
        call tf_THETA_lepton(pexp(0,7),p(0,7),n_lhco,weight)
        call tf_PHI_lepton(pexp(0,7),p(0,7),n_lhco,weight)

        n_lhco=tag_lhco(9)
        call tf_E_jet(pexp(0,9),p(0,9),n_lhco,weight)
        call tf_THETA_jet(pexp(0,9),p(0,9),n_lhco,weight)
        call tf_PHI_jet(pexp(0,9),p(0,9),n_lhco,weight)
...
c
        ...
        tf_E_for_part=1d0
        n_lhco=tag_lhco(4)
        call tf_E_jet(pexp(0,4),momenta(0,4),n_lhco,tf_E_for_part)
        ...
        tf_E_for_part=1d0
        n_lhco=tag_lhco(5)
        call tf_E_jet(pexp(0,5),momenta(0,5),n_lhco,tf_E_for_part)
        ...
        tf_E_for_part=1d0
        n_lhco=tag_lhco(7)
        call tf_E_lepton(pexp(0,7),momenta(0,7),n_lhco,tf_E_for_part)
        ...
        tf_E_for_part=1d0
        n_lhco=tag_lhco(9)
        call tf_E_jet(pexp(0,9),momenta(0,9),n_lhco,tf_E_for_part)
...
c
      integer i,k,n_lhco
        ...
        tf_E_for_4=1d0
        n_lhco=tag_lhco(4)
        call tf_E_jet(pexp(0,4),momenta(0,4),n_lhco,tf_E_for_4)
...
c
      integer i,k,n_lhco
        ...
        tf_E_for_5=1d0
        n_lhco=tag_lhco(5)
        call tf_E_jet(pexp(0,5),momenta(0,5),n_lhco,tf_E_for_5)
...
c
      integer i,k,n_lhco
        ...
        tf_E_for_7=1d0
        n_lhco=tag_lhco(7)
        call tf_E_lepton(pexp(0,7),momenta(0,7),n_lhco,tf_E_for_7)
...
C+-----------------------------------------------------------------------+
        ...
        double precision function tf_E_for_9()
...
c
      integer i,k,n_lhco
        ...
        tf_E_for_9=1d0
        n_lhco=tag_lhco(9)
        call tf_E_jet(pexp(0,9),momenta(0,9),n_lhco,tf_E_for_9)
