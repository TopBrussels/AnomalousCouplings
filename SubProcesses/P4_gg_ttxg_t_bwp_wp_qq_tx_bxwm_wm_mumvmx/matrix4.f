...
C     1 T(1,2,6) T(3,9) T(4,5)
      DATA DENOM(2)/1/
      DATA (CF(I,  2),I=  1,  4) /   12,   36,    0,   12/
C     1 T(1,2,9) T(3,6) T(4,5)
      DATA DENOM(3)/1/
      DATA (CF(I,  3),I=  1,  4) /   12,    0,   36,   12/
C     1 T(1,3,6) T(2,9) T(4,5)
      DATA DENOM(4)/1/
      DATA (CF(I,  4),I=  1,  4) /    0,   12,   12,   36/
C     1 T(1,3,9) T(2,6) T(4,5)
C     ----------
C     BEGIN CODE
C     ----------
      CALL VXXXXX(P(0,1),ZERO,NHEL(1),-1*IC(1),W(1,1))
      CALL OXXXXX(P(0,2),ZERO,NHEL(2),-1*IC(2),W(1,2))
      CALL IXXXXX(P(0,9),ZERO,NHEL(9),-1*IC(9),W(1,3))
      CALL FFV1_2(W(1,3),W(1,1),GC_7,ZERO,ZERO,W(1,4))
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV1P0_3(W(1,3),W(1,2),GC_7,ZERO,ZERO,W(1,4))
