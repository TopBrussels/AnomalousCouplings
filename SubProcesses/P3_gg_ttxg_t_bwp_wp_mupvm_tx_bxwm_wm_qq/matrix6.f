...
C     *   Decay: t~ > b~ w- NP=2 QED=2 @0 NP=2 QED=2 
C     *     Decay: w- > s c~ NP=2 QED=2 @0 NP=2 QED=2 
C     Process: d d~ > t t~ g NP=2 QED=2 @3 NP=2 QED=2 
C     *   Decay: t > b w+ NP=2 QED=2 @0 NP=2 QED=2 
C     *     Decay: w+ > mu+ vm NP=2 QED=2 @0 NP=2 QED=2 
C     *   Decay: t~ > b~ w- NP=2 QED=2 @0 NP=2 QED=2 
C     *     Decay: w- > d u~ NP=2 QED=2 @0 NP=2 QED=2 
C     Process: s s~ > t t~ g NP=2 QED=2 @3 NP=2 QED=2 
C     *   Decay: t > b w+ NP=2 QED=2 @0 NP=2 QED=2 
C     *     Decay: w+ > mu+ vm NP=2 QED=2 @0 NP=2 QED=2 
C     *   Decay: t~ > b~ w- NP=2 QED=2 @0 NP=2 QED=2 
C     *     Decay: w- > d u~ NP=2 QED=2 @0 NP=2 QED=2 
...
C     1 T(2,1) T(7,8) T(9,3,6)
      DATA DENOM(2)/1/
      DATA (CF(I,  2),I=  1,  4) /   12,   36,    0,   12/
C     1 T(2,6) T(7,8) T(9,3,1)
      DATA DENOM(3)/1/
      DATA (CF(I,  3),I=  1,  4) /   12,    0,   36,   12/
C     1 T(3,1) T(7,8) T(9,2,6)
      DATA DENOM(4)/1/
      DATA (CF(I,  4),I=  1,  4) /    0,   12,   12,   36/
C     1 T(3,6) T(7,8) T(9,2,1)
C     ----------
C     BEGIN CODE
C     ----------
      ...
      CALL FFV1_2(W(1,1),W(1,3),GC_7,ZERO,ZERO,W(1,4))
...
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,4),W(1,2),W(1,9),GC_7,AMP(1))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_7,ZERO,ZERO,W(1,4))
      CALL FFV1_1(W(1,7),W(1,3),GC_7,MDL_MT,MDL_WT,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,6),W(1,8),W(1,4),GC_7,AMP(2))
      CALL FFV1_2(W(1,6),W(1,3),GC_7,MDL_MT,MDL_WT,W(1,8))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,8),W(1,7),W(1,4),GC_7,AMP(3))
      CALL FFV1_1(W(1,2),W(1,3),GC_7,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,1),W(1,8),W(1,9),GC_7,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL VVV1_0(W(1,3),W(1,4),W(1,9),GC_6,AMP(5))
      JAMP(1)=+1D0/2D0*(-1D0/3D0*AMP(2)-1D0/3D0*AMP(3))
      JAMP(2)=+1D0/2D0*(+AMP(1)+AMP(2)-IMAG1*AMP(5))
      JAMP(3)=+1D0/2D0*(+AMP(3)+AMP(4)+IMAG1*AMP(5))
      JAMP(4)=+1D0/2D0*(-1D0/3D0*AMP(1)-1D0/3D0*AMP(4))
