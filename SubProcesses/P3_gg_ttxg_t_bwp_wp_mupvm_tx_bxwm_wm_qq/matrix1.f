...
C     
C     Process: g g > t t~ g NP=2 QED=2 @3 NP=2 QED=2 
...
C     
      ...
      PARAMETER (NWAVEFUNCS=26, NCOLOR=6)
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
      COMPLEX*16 IMAG1
...
C     1 T(1,2,9,3,6) T(7,8)
      DATA DENOM(2)/3/
      DATA (CF(I,  2),I=  1,  6) /   -8,   64,    1,   10,   -8,    1/
C     1 T(1,9,2,3,6) T(7,8)
      DATA DENOM(3)/3/
      DATA (CF(I,  3),I=  1,  6) /   -8,    1,   64,   -8,   10,    1/
C     1 T(2,1,9,3,6) T(7,8)
      DATA DENOM(4)/3/
      DATA (CF(I,  4),I=  1,  6) /    1,   10,   -8,   64,    1,   -8/
C     1 T(2,9,1,3,6) T(7,8)
      DATA DENOM(5)/3/
      DATA (CF(I,  5),I=  1,  6) /    1,   -8,   10,    1,   64,   -8/
C     1 T(7,8) T(9,1,2,3,6)
      DATA DENOM(6)/3/
      DATA (CF(I,  6),I=  1,  6) /   10,    1,    1,   -8,   -8,   64/
C     1 T(7,8) T(9,2,1,3,6)
C     ----------
C     BEGIN CODE
C     ----------
      CALL VXXXXX(P(0,1),ZERO,NHEL(1),-1*IC(1),W(1,1))
      CALL VXXXXX(P(0,2),ZERO,NHEL(2),-1*IC(2),W(1,2))
      CALL VXXXXX(P(0,9),ZERO,NHEL(9),+1*IC(9),W(1,3))
      CALL VVV1P0_1(W(1,1),W(1,2),GC_6,ZERO,ZERO,W(1,4))
      CALL OXXXXX(P(0,3),MDL_MB,NHEL(3),+1*IC(3),W(1,5))
      CALL IXXXXX(P(0,4),MDL_MM,NHEL(4),-1*IC(4),W(1,6))
      CALL OXXXXX(P(0,5),ZERO,NHEL(5),+1*IC(5),W(1,7))
      CALL FFV2_3(W(1,6),W(1,7),GC_17,MDL_MW,MDL_WW,W(1,8))
      CALL FFV2_3_4_8_1(W(1,5),W(1,8),GC_31,GC_22,GC_32,GC_23,MDL_MT
     $ ,MDL_WT,W(1,7))
      CALL IXXXXX(P(0,6),MDL_MB,NHEL(6),-1*IC(6),W(1,8))
      CALL OXXXXX(P(0,7),ZERO,NHEL(7),+1*IC(7),W(1,5))
...
C     Amplitude(s) for diagram number 1
      CALL VVV1_0(W(1,4),W(1,9),W(1,3),GC_6,AMP(1))
      CALL FFV1_1(W(1,7),W(1,3),GC_7,MDL_MT,MDL_WT,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,6),W(1,8),W(1,4),GC_7,AMP(2))
      CALL FFV1_2(W(1,6),W(1,3),GC_7,MDL_MT,MDL_WT,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,5),W(1,7),W(1,4),GC_7,AMP(3))
      CALL FFV1_1(W(1,7),W(1,1),GC_7,MDL_MT,MDL_WT,W(1,4))
      CALL FFV1_2(W(1,6),W(1,2),GC_7,MDL_MT,MDL_WT,W(1,10))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,10),W(1,4),W(1,3),GC_7,AMP(4))
      CALL VVV1P0_1(W(1,2),W(1,3),GC_6,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,6),W(1,4),W(1,11),GC_7,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,5),W(1,4),W(1,2),GC_7,AMP(6))
      CALL FFV1_1(W(1,7),W(1,2),GC_7,MDL_MT,MDL_WT,W(1,4))
      CALL FFV1_2(W(1,6),W(1,1),GC_7,MDL_MT,MDL_WT,W(1,12))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,12),W(1,4),W(1,3),GC_7,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,12),W(1,7),W(1,11),GC_7,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,12),W(1,8),W(1,2),GC_7,AMP(9))
      CALL VVV1P0_1(W(1,1),W(1,3),GC_6,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,6),W(1,4),W(1,12),GC_7,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,10),W(1,7),W(1,12),GC_7,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL VVV1_0(W(1,12),W(1,2),W(1,9),GC_6,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,5),W(1,4),W(1,1),GC_7,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,10),W(1,8),W(1,1),GC_7,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL VVV1_0(W(1,1),W(1,11),W(1,9),GC_6,AMP(15))
      CALL VVVV1P0_1(W(1,1),W(1,2),W(1,3),GC_8,ZERO,ZERO,W(1,11))
      CALL VVVV3P0_1(W(1,1),W(1,2),W(1,3),GC_8,ZERO,ZERO,W(1,9))
      CALL VVVV4P0_1(W(1,1),W(1,2),W(1,3),GC_8,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,6),W(1,7),W(1,11),GC_7,AMP(16))
      CALL FFV1_0(W(1,6),W(1,7),W(1,9),GC_7,AMP(17))
      CALL FFV1_0(W(1,6),W(1,7),W(1,10),GC_7,AMP(18))
      JAMP(1)=+AMP(1)-IMAG1*AMP(3)-IMAG1*AMP(5)+AMP(6)-AMP(15)
     $ +AMP(18)-AMP(16)
     ...
     $ -AMP(18)-AMP(17)
      JAMP(6)=+AMP(1)+IMAG1*AMP(2)+IMAG1*AMP(8)+AMP(9)-AMP(15)
     $ +AMP(18)-AMP(16)
