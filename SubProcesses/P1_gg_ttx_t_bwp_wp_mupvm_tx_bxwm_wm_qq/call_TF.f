...
C+-----------------------------------------------------------------------+
        ...
        c_point(perm, 3,3,1)=pt(pexp_init(0,2+perm_id(1)))
        ...
        c_point(perm, 4,3,1)=pt(pexp_init(0,2+perm_id(2)))
        ...
        c_point(perm, 6,3,1)=pt(pexp_init(0,2+perm_id(4)))
        ...
        c_point(perm, 7,3,1)=pt(pexp_init(0,2+perm_id(5)))
        ...
        c_point(perm, 8,3,1)=pt(pexp_init(0,2+perm_id(6)))
...
C|                                                                       |
C|     purpose: returns the weight by the coeficient coming from the     |
C|              transfer_fct                                             |
C+-----------------------------------------------------------------------+
...
c      write(*,*) 'In transfer_fct: pt(p(0,X)) =',pt(p(0,X))
...
C+-----------------------------------------------------------------------+
C|     Subroutine: tf_PT_for_part(MG_num)                                 |
C|                                                                       |
