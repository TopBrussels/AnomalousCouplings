...
C     ----------
      ...
      CALL OXXXXX(P(0,3),MDL_MB,NHEL(3),+1*IC(3),W(1,2))
      CALL IXXXXX(P(0,4),MDL_MM,NHEL(4),-1*IC(4),W(1,1))
      CALL OXXXXX(P(0,5),ZERO,NHEL(5),+1*IC(5),W(1,4))
      CALL FFV2_3(W(1,1),W(1,4),GC_17,MDL_MW,MDL_WW,W(1,5))
      CALL FFV2_3_4_8_1(W(1,2),W(1,5),GC_31,GC_22,GC_32,GC_23,MDL_MT
     $ ,MDL_WT,W(1,4))
      ...
      CALL FFV2_3(W(1,1),W(1,2),GC_17,MDL_MW,MDL_WW,W(1,6))
      CALL FFV2_3_4_8_2(W(1,5),W(1,6),GC_44,GC_43,GC_45,GC_42,MDL_MT
     $ ,MDL_WT,W(1,1))
