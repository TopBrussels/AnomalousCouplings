...
C     
C     Process: g g > t t~ NP=2 QED=2 @2 NP=2 QED=2 
...
C     ----------
      ...
      CALL OXXXXX(P(0,3),MDL_MB,NHEL(3),+1*IC(3),W(1,4))
      CALL OXXXXX(P(0,4),ZERO,NHEL(4),+1*IC(4),W(1,5))
      CALL IXXXXX(P(0,5),ZERO,NHEL(5),-1*IC(5),W(1,6))
      CALL FFV2_3(W(1,6),W(1,5),GC_17,MDL_MW,MDL_WW,W(1,7))
      CALL FFV2_3_4_8_1(W(1,4),W(1,7),GC_31,GC_22,GC_32,GC_23,MDL_MT
     $ ,MDL_WT,W(1,6))
      CALL IXXXXX(P(0,6),MDL_MB,NHEL(6),-1*IC(6),W(1,7))
      CALL OXXXXX(P(0,7),MDL_MM,NHEL(7),+1*IC(7),W(1,4))
      CALL IXXXXX(P(0,8),ZERO,NHEL(8),-1*IC(8),W(1,5))
      CALL FFV2_3(W(1,5),W(1,4),GC_17,MDL_MW,MDL_WW,W(1,8))
      CALL FFV2_3_4_8_2(W(1,7),W(1,8),GC_44,GC_43,GC_45,GC_42,MDL_MT
     $ ,MDL_WT,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,5),W(1,6),W(1,3),GC_7,AMP(1))
      CALL FFV1_1(W(1,6),W(1,1),GC_7,MDL_MT,MDL_WT,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,5),W(1,3),W(1,2),GC_7,AMP(2))
      CALL FFV1_2(W(1,5),W(1,1),GC_7,MDL_MT,MDL_WT,W(1,3))
